...
REQUIRED_FIELD_ERROR: Final = 'This field is required.'
NOT_NULL_FIELD_ERROR: Final = 'This field may not be null.'
NOT_BLANK_FIELD_ERROR: Final = 'This field may not be blank.'
NOT_A_VALID_STRING_FIELD_ERROR: Final = 'Not a valid string.'
MUST_BE_A_VALID_BOOLEAN_FIELD_ERROR: Final = 'Must be a valid boolean.'
...
class CategoryInvalidBodyFixture:
    ...
    name_not_a_string: HttpExpect
    description_not_a_string: HttpExpect
    is_active_none: HttpExpect
    is_active_empty: HttpExpect
    is_active_not_a_boolean: HttpExpect
        ...
        return CategoryInvalidBodyFixture(
            ...
            body_empty=HttpExpect(
                ...
                exception=ValidationError({
                    'name': [
                        ErrorDetail(REQUIRED_FIELD_ERROR, 'required')
                    ],
                })
            ),
            name_empty=HttpExpect(
                ...
                exception=ValidationError({
                    'name': [
                        ErrorDetail(NOT_BLANK_FIELD_ERROR, 'blank')
                    ],
                })
            ),
            name_none=HttpExpect(
                ...
                exception=ValidationError({
                    'name': [
                        ErrorDetail(NOT_NULL_FIELD_ERROR, 'null')
                    ],
                })
            ),
            name_not_a_string=HttpExpect(
                ...
                exception=ValidationError({
                    'name': [
                        ErrorDetail(NOT_A_VALID_STRING_FIELD_ERROR, 'invalid')
                    ],
                })
            ),
            description_not_a_string=HttpExpect(
            ...
            is_active_empty=HttpExpect(
                ...
                exception=ValidationError({
                    ...
                    'is_active': [
                        ErrorDetail(
                            MUST_BE_A_VALID_BOOLEAN_FIELD_ERROR, 'invalid')
                    ],
                })
            ),
            is_active_not_a_boolean=HttpExpect(
    ...
    def arrange():
        ...
        return CategoryEntityValidationErrorFixture(
            ...
            name_not_a_string=HttpExpect(
                ...
                exception=EntityValidationException({
                    'name': [
                        NOT_A_VALID_STRING_FIELD_ERROR
                    ]
                })),
            name_too_long=HttpExpect(
                request=Request(
            ...
            is_active_empty=HttpExpect(
                ...
                exception=EntityValidationException({
                    ...
                    'is_active': [
                        MUST_BE_A_VALID_BOOLEAN_FIELD_ERROR
                    ]
                })),
            is_active_not_a_boolean=HttpExpect(
                request=Request(
...
class CreateCategoryApiFixture:
    ...
    def arrange_for_invalid_requests():
        ...
        return [
            ...
            pytest.param(fixture.is_active_not_a_boolean,
                         id='is_active_not_a_boolean'),
        ]
    ...
    def arrange_for_entity_validation_error():
        ...
        return [
            pytest.param(fixture.name_none, id='name_none'),
            pytest.param(fixture.name_empty, id='name_empty'),
            pytest.param(fixture.name_not_a_string, id='name_not_a_string'),
            pytest.param(fixture.name_too_long, id='name_too_long'),
            pytest.param(fixture.description_not_a_string,
                         id='description_not_a_string'),
            pytest.param(fixture.is_active_none, id='is_active_none'),
            pytest.param(fixture.is_active_empty, id='is_active_empty'),
            pytest.param(fixture.is_active_not_a_boolean,
                         id='is_active_not_a_boolean'),
...
class ListCategoriesApiFixture:
    ...
    def arrange_incremented_with_created_at():
        ...
        CategoriesNamed = namedtuple('CategoriesNamed', ['first', 'second', 'third', 'fourth'])
