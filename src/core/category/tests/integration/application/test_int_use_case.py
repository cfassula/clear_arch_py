...
class TestCreateCategoryUseCaseInt(unittest.TestCase):
    ...
    def test_execute(self):
        input_param = CreateCategoryUseCase.Input(name='test')
        ...
        self.assertEqual(entity.name, 'test')
        self.assertEqual(entity.description, 'some test')
        self.assertTrue(entity.is_active)
        self.assertIsNotNone(entity.created_at)
        ...
        self.assertEqual(entity.name, 'test 4')
        self.assertEqual(entity.description, 'some test---')
...
class TestGetCategoryUseCaseInt(unittest.TestCase):
    ...
    def test_execute(self):
        ...
        input_param = GetCategoryUseCase.Input(id=entity.id)
        output = self.use_case.execute(input_param)
...
@pytest.mark.django_db
class TestListCategoryUseCaseInt(unittest.TestCase):
