...
class TestCategoryResourcePutMethodInt:
    ...
    def test_entity_validation_error(self, http_expect: HttpExpect):
        ...
        with(
            ...
            print(assert_exception.value.error)
            print(http_expect.exception.error)
    ...
    def test_throw_exception_when_id_is_invalid(self):
        ...
        with pytest.raises(ValidationError) as assert_exception:
            self.resource.put(request, 'invalid id')
    ...
    def test_throw_exception_when_category_not_found(self):
        uuid_value = 'af468b2c-8f4b-4e8d-8e0b-8b4c4a3c1b8c'
        request = make_request(http_method='put', send_data={'name': 'new name'})
