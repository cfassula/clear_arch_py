...
class TestCategoryDjangoRepositoryInt(unittest.TestCase):
    ...
    def test_insert(self):
        ...
        model = CategoryModel.objects.get(pk=category.id)
        self.assertEqual(str(model.id), category.id)
        self.assertEqual(model.name, 'Test Category 2')
    ...
    def test_throw_not_found_exception_in_find_by_id(self):
        ...
        with self.assertRaises(NotFoundException) as assert_error:
            self.repo.find_by_id('af3e4b3e-0b3d-4b3b-8b3b-3b3b3b3b3b3b')
        self.assertEqual(
    ...
    def test_update(self):
        ...
        model = CategoryModel.objects.get(pk=category.id)
        self.assertEqual(str(model.id), category.id)
        self.assertEqual(model.name, 'Test Category Updated')
        self.assertEqual(model.description, 'Test Description Updated')
        self.assertTrue(model.is_active)
        self.assertEqual(model.created_at, category.created_at)
    ...
    def test_throw_not_found_exception_in_delete(self):
        ...
        with self.assertRaises(NotFoundException) as assert_error:
            self.repo.delete('af3e4b3e-0b3d-4b3b-8b3b-3b3b3b3b3b3b')
        self.assertEqual(
            assert_error.exception.args[0],
            "Entity not found using ID 'af3e4b3e-0b3d-4b3b-8b3b-3b3b3b3b3b3b'")
    ...
    def test_search_when_input_params_is_empty(self):
        models = baker.make(
            CategoryModel,
            _quantity=16,
